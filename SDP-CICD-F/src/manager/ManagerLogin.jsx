  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setTimeout(() => navigate('/managerhome'), 1500);
      } else {
    ...
    >
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-black">Manager Login</h1>
          <p className="mt-2 text-gray-900">Enter your credentials to access manager panel.</p>
        </div>
        ...
        <div className="flex justify-center mt-6">
          <button
            ...
            className="px-6 py-2 text-sm rounded-xl bg-yellow-500 hover:bg-black-500 text-white font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:-translate-y-1 shadow-md hover:shadow-violet-500/40 flex items-center gap-2"
          >
